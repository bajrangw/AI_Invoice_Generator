...
const SignUp = () => {
  ...
  const validateName = (name) => {;
    ...
    if (!name.length > 50) return "Name must be less then 50 characters";
    return "";
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (err.response && err.response.data && err.response.data.message) {
        ...
        setError("Registration faild. Please try again.");
      }
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-4">
          <div className="w-12 h-12 bg-gradient-to-r from-blue-950 to-blue-900 rounded-xl mx-auto mb-4 flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start pt-2">
            <input
              type="checkbox"
              id="terms"
              className="w-4 h-4 text-black border-gray-300 rounded focus:ring-black mt-1 cursor-pointer"
              required
            />
